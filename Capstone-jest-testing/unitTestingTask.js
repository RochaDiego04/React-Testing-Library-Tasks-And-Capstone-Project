(function (root, factory) {
  ...
  unitTestingTask.createFormatter = createFormatter;
  ...
  var register = (unitTestingTask.register = function (name, format) {
    formatters[name] = unitTestingTask.createFormatter(format);
  ...
  unitTestingTask.unitTestingTaskFunction = unitTestingTask;
  unitTestingTask.lang = lang;
  unitTestingTask.register = register;
  unitTestingTask.languages = languages;
  unitTestingTask.tokens = tokens;
  return unitTestingTask;
});
